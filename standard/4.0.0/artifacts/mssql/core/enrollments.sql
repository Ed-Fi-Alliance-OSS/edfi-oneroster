...
-- =============================================
-- MS SQL Server Setup for Enrollments (Data Standard 4)
-- Creates table, indexes, and refresh procedure
-- Based on PostgreSQL enrollments materialized view
-- DS4: BeginDate is NOT part of StaffSectionAssociation identity
-- =============================================
...
BEGIN
    ...
    BEGIN TRY
        ...
        student_enrollments_formatted AS (
            SELECT
                -- DS4: StudentSectionAssociation already had beginDate as part of identity
                LOWER(CONVERT(VARCHAR(32), HASHBYTES('MD5',
                    CAST(
